...
:root { color-scheme: light dark; supported-color-schemes: light dark;} @media (prefers-color-scheme: dark) { /* Custom Dark Mode Background Color */ .darkmode {background-color: #F4A100 !important;} .DMBG02 {background-color: #D65C04 !important;} /* Custom Dark Mode Font Colors */ h1, h2, h3, h4 {color: #A9001E !important;} p, span, b, p > a {color: #111111 !important;} a {color: #FEFEFE !important;} h5, h5 > a {color: #FFF9BD !important;} }
  ...
  <!--[if !((gte mso 9)|(IE))]>
    ...
    <body bgcolor="#eaeced" style="font-family:'Roboto', -apple-system, BlinkMacSystemFont, Helvetica, Arial, sans-serif; color:#8a959e"><span class="preheader" summary="preheader" style="display:none !important; Margin-left:-9999 !important; width:0 !important; height:0 !important; visibility:hidden !important; min-width:0 !important; min-height:0 !important; font-size:0 !important; line-height:0 !important"
      width="0 !important" height="0 !important">Merci<em style="text-transform: capitalize"> ${username.capitalize()}</em> pour votre message et l'intérêt que vous portez à mon site. 
      <br>Une réponse à votre demande vous sera envoyée au plus vite. En espérant vous revoir au plus vite sur dibodev ! 
      Cordialement, Léo.</span>
    <!--<![endif]-->
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td align="center">
                                          ...
                                          text-transform: capitalize; word-break: break-word;">Bonjour ${username}</h1>
                                        </td>
                                      </tr>
                                      <tr height="40">
                                        <td>&nbsp;</td>
                                      ...
                                      <tr>
                                        <td align="center">
                                          ...
                                          font-weight:300; margin:0 0 1em 0; font-size:18px; color:#8a959e; letter-spacing:0;
                                           line-height:38px">Merci<em style="text-transform: capitalize"> ${username}</em> pour votre message et l'intérêt que vous portez à mon site.</p>
                                          <p
                                          ...
                                          Une réponse à votre demande vous sera envoyée au plus vite. En espérant vous revoir au plus vite sur dibodev ! Cordialement, Léo.</p>
                                        </td>
                                      </tr>
                                      <tr height="50">
                                        <td>&nbsp;</td>
                                          ...
                                          <div>
                                            <!--[if mso]>
                                              ...
                                              fillcolor="#FF3366">
                                                ...
                                                <center>
                                                <![endif]-->
                                                <a class="main-cta" summary="main-cta" href="mailto:contact@dibodev.com"
